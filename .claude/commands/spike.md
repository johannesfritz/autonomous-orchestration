Start an objective-driven technical investigation.

1. Ask for the ONE question this spike needs to answer
...
The goal is a Knowledge Artifact: Verdict, PoC, Architecture Draft, or Root Cause.

Usage:
- /spike Can we use WebSockets for real-time updates?
- /spike How should the refund flow behave for partial orders?
